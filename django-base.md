...
> `venv_name` `project_name` `app_name` -  это не конкретные названия, это значит, что вы сами придумываете названия для виртуальной среды, приложений проекта, example переводится как **_пример_**, это тоже не конкретное название чего-либо.
...
### Static & Media Files
### Static Files
Статические файлы в веб-разработке, CSS, JavaScript, mp3, ogg, png, jpg и т.д. и изображения, хранятся на сервере.<br>
